...
<?php 
include "koneksi.php";
$stmt = "select id,nama, nama_tk, jenis_kelamin, agama from calon";
    ...
    <div class="hero-input">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a style="color: white;" href="http://localhost/latihanphp/proses.php?id=<?php echo $row["id"] ?>">tanda</a></td>
                <?php $i++;?>
            </tr>
            <?php endwhile;?>
        </tbody>
